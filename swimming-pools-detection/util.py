...
def resultats(gis, results):
    
    parcelles = gis.content.get('becf5e9fdda643e48465991e5c636572')
    piscines = gis.content.get('f88d8a5c4abf49b28ba06b93c3047982').layers[0]
    
    parcellesnon = gis.content.get('aea0adac29a8486086973b51476e3626')
    parcellesoui = gis.content.get('358fe7988cb34da284083fe1eed6a501')
    
  
    symbolred = {"type": "picture-marker","url":"http://maps.esrifrance.fr/portal/sharing/rest/content/items/0486e26c62894a398013f595ca4de94e/data","width":"30px","height":"30px"}    


    
    results.add_layer(parcelles)
    results.add_layer(parcellesnon)
    results.add_layer(parcellesoui)
    results.add_layer(piscines, {"renderer":"autocast","type" : "simple","symbol": symbolred})
